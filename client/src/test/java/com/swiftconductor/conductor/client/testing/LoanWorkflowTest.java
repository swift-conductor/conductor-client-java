 ...
 */
package com.swiftconductor.conductor.client.testing;
...
import com.swiftconductor.conductor.common.run.WorkflowTestRequest;
...
public class LoanWorkflowTest extends AbstractWorkflowTests {
    ...
    /**
     * Uses mock inputs to verify the workflow execution and input/outputs of the
     * tasks
     */
    ...
    public void verifyWorkflowExecutionWithMockInputs() throws IOException {
        ...
        assertNotNull(def);
        Map<String, List<WorkflowTestRequest.TaskMock>> testInputs = getTestInputs(
                "/test_data/loan_workflow_input.json");
        ...
        // get credit score received the right account number from the output of the
        // fetch user
        // details
        ...
        assertEquals(workflowInput.getLoanAmount().toString(),

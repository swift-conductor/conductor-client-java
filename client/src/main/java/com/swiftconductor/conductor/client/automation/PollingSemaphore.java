...
/**
 * A class wrapping a semaphore which holds the number of permits available for
 * polling and executing tasks.
 */
class PollingSemaphore {
    ...
    /**
     * Signals that processing is complete and the specified number of permits can
     * be released.
     */
    ...
    /**
     * Signals if processing is allowed based on whether specified number of permits
     * can be acquired.
     *
     * @param numSlots
     *            the number of permits to acquire
     * @return {@code true} - if permit is acquired {@code false} - if permit could
     *         not be acquired
     */

...
public class AnnotatedWorkerTests {
    ...
    static class MultipleInputParams {
        @Worker(value = "test_1", threadCount = 3, pollingInterval = 333)
    ...
    void multipleInputParams() throws NoSuchMethodException {
        ...
        var annotatedWorker = new AnnotatedWorker("test_1",
                worker.getClass().getMethod("doWork", Bike.class, Car.class), worker);
    ...
    void pollingIntervalTest() throws NoSuchMethodException {
        ...
        AnnotatedWorkerHost annotatedWorkerHost = new AnnotatedWorkerHost(mock(TaskClient.class));
        annotatedWorkerHost.addBean(worker);
        annotatedWorkerHost.startPolling();
        List<AbstractWorker> workers = annotatedWorkerHost.getWorkers();
        assertNotNull(workers);
        assertEquals(1, workers.size());
        AbstractWorker taskWorker = workers.get(0);
        assertEquals(333, taskWorker.getPollingInterval());

        var worker2 = new AnotherAnnotationInput();
        annotatedWorkerHost = new AnnotatedWorkerHost(mock(TaskClient.class));
        annotatedWorkerHost.addBean(worker2);
        annotatedWorkerHost.startPolling();
        workers = annotatedWorkerHost.getWorkers();
        assertNotNull(workers);
        assertEquals(1, workers.size());
        ...
        annotatedWorkerHost = new AnnotatedWorkerHost(mock(TaskClient.class), config);
        annotatedWorkerHost.addBean(worker2);
        annotatedWorkerHost.startPolling();
        workers = annotatedWorkerHost.getWorkers();
        assertNotNull(workers);
    ...
    void threadCountTest() throws NoSuchMethodException {
        ...
        AnnotatedWorkerHost annotatedWorkerHost = new AnnotatedWorkerHost(mock(TaskClient.class), config);
        annotatedWorkerHost.addBean(worker);
        annotatedWorkerHost.addBean(worker2);

        annotatedWorkerHost.startPolling();
        WorkerHost runner = annotatedWorkerHost.getWorkerHost();
        ...
        annotatedWorkerHost.startPolling();
        runner = annotatedWorkerHost.getWorkerHost();

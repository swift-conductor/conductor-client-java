...
public class EventClient extends ClientBase {
    ...
    public void registerEventHandler(EventHandler eventHandler) {
        ...
        stub.addEventHandler(EventServicePb.AddEventHandlerRequest.newBuilder()
                .setHandler(protoMapper.toProto(eventHandler)).build());
    }
    ...
    public void updateEventHandler(EventHandler eventHandler) {
        Preconditions.checkNotNull(eventHandler, "Event handler definition cannot be null");
        stub.updateEventHandler(EventServicePb.UpdateEventHandlerRequest.newBuilder()
                .setHandler(protoMapper.toProto(eventHandler)).build());
    }
    ...
    public Iterator<EventHandler> getEventHandlers(String event, boolean activeOnly) {
        ...
        EventServicePb.GetEventHandlersForEventRequest.Builder request = EventServicePb.GetEventHandlersForEventRequest
                .newBuilder().setEvent(event).setActiveOnly(activeOnly);
    ...
    public void unregisterEventHandler(String name) {
        ...
        stub.removeEventHandler(EventServicePb.RemoveEventHandlerRequest.newBuilder().setName(name).build());
    }
}
